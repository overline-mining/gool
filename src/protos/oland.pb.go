...
var file_oland_proto_goTypes = []interface{}{
...
func file_oland_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_oland_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Plot); i {
			case 0:
				return &v.state
			case 1:
		...
		file_oland_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlotAttribute); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_oland_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlotPanel); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
