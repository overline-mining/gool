...
func (c *roverClient) Join(ctx context.Context, in *RoverIdent, opts ...grpc.CallOption) (Rover_JoinClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rover_ServiceDesc.Streams[0], "/Rover/Join", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *roverClient) CollectBlock(ctx context.Context, opts ...grpc.CallOption) (Rover_CollectBlockClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rover_ServiceDesc.Streams[1], "/Rover/CollectBlock", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *roverClient) ReportSyncStatus(ctx context.Context, in *RoverSyncStatus, opts ...grpc.CallOption) (*Null, error) {
	out := new(Null)
	err := c.cc.Invoke(ctx, "/Rover/ReportSyncStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roverClient) ReportBlockRange(ctx context.Context, in *RoverMessage_RoverBlockRange, opts ...grpc.CallOption) (*Null, error) {
	out := new(Null)
	err := c.cc.Invoke(ctx, "/Rover/ReportBlockRange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roverClient) IsBeforeSettleHeight(ctx context.Context, in *SettleTxCheckReq, opts ...grpc.CallOption) (*SettleTxCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Rover/IsBeforeSettleHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Rover_ReportSyncStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Rover/ReportSyncStatus",
	}
...
func _Rover_ReportBlockRange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Rover/ReportBlockRange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rover_IsBeforeSettleHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Rover/IsBeforeSettleHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
