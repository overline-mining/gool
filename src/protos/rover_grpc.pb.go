...
func (c *roverClient) Join(ctx context.Context, in *RoverIdent, opts ...grpc.CallOption) (Rover_JoinClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rover_ServiceDesc.Streams[0], Rover_Join_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *roverClient) CollectBlock(ctx context.Context, opts ...grpc.CallOption) (Rover_CollectBlockClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rover_ServiceDesc.Streams[1], Rover_CollectBlock_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *roverClient) ReportSyncStatus(ctx context.Context, in *RoverSyncStatus, opts ...grpc.CallOption) (*Null, error) {
	out := new(Null)
	err := c.cc.Invoke(ctx, Rover_ReportSyncStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roverClient) ReportBlockRange(ctx context.Context, in *RoverMessage_RoverBlockRange, opts ...grpc.CallOption) (*Null, error) {
	out := new(Null)
	err := c.cc.Invoke(ctx, Rover_ReportBlockRange_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roverClient) IsBeforeSettleHeight(ctx context.Context, in *SettleTxCheckReq, opts ...grpc.CallOption) (*SettleTxCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, Rover_IsBeforeSettleHeight_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roverClient) GetQueuedMarkedTxs(ctx context.Context, in *MarkedTxsReq, opts ...grpc.CallOption) (*QueuedMarkedTxsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Rover_GetQueuedMarkedTxs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
