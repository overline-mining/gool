...
func (c *roverClient) Join(ctx context.Context, in *RoverIdent, opts ...grpc.CallOption) (Rover_JoinClient, error) {
	...
	x := &roverJoinClient{ClientStream: stream}
...
func (c *roverClient) CollectBlock(ctx context.Context, opts ...grpc.CallOption) (Rover_CollectBlockClient, error) {
	...
	x := &roverCollectBlockClient{ClientStream: stream}
	return x, nil
}
...
func _Rover_Join_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RoverServer).Join(m, &roverJoinServer{ServerStream: stream})
}
...
func _Rover_CollectBlock_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RoverServer).CollectBlock(&roverCollectBlockServer{ServerStream: stream})
}
