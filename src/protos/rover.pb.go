...
func (x *RoverMessage) GetPayload() isRoverMessage_Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *RoverMessage) GetResync() *RoverMessage_Resync {
	if x != nil {
		if x, ok := x.Payload.(*RoverMessage_Resync_); ok {
			return x.Resync
		}
	}
	return nil
...
func (x *RoverMessage) GetFetchBlock() *RoverMessage_FetchBlock {
	if x != nil {
		if x, ok := x.Payload.(*RoverMessage_FetchBlock_); ok {
			return x.FetchBlock
		}
	}
	return nil
...
func (x *RoverMessage) GetRoverBlockRange() *RoverMessage_RoverBlockRange {
	if x != nil {
		if x, ok := x.Payload.(*RoverMessage_RoverBlockRange_); ok {
...
func (x *RoverMessage) GetLatestBlock() *RoverMessage_LatestBlock {
	if x != nil {
		if x, ok := x.Payload.(*RoverMessage_LatestBlock_); ok {
...
var file_rover_proto_rawDesc = string([]byte{
...
var (
	...
	file_rover_proto_rawDescData []byte
)

func file_rover_proto_rawDescGZIP() []byte {
	file_rover_proto_rawDescOnce.Do(func() {
		file_rover_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_rover_proto_rawDesc), len(file_rover_proto_rawDesc)))
	})
...
func file_rover_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_rover_proto_rawDesc), len(file_rover_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
