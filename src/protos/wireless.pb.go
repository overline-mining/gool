...
var file_wireless_proto_rawDesc = string([]byte{
...
var (
	...
	file_wireless_proto_rawDescData []byte
)

func file_wireless_proto_rawDescGZIP() []byte {
	file_wireless_proto_rawDescOnce.Do(func() {
		file_wireless_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wireless_proto_rawDesc), len(file_wireless_proto_rawDesc)))
	})
...
func file_wireless_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wireless_proto_rawDesc), len(file_wireless_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
